...
num_features = ['temperature', 'humidity', 'precipitation_intensity', 'avg_sched_headway', 'time_window',
...
fp = os.path.join('../evaluation', 'no_speed_simple_day_ahead_012_raw_results.pkl')
...
fp = os.path.join('../evaluation', 'no_speed_simple_day_ahead_234_raw_results.pkl')
pd.concat(results_df_arr).to_pickle(fp)
...
fp = os.path.join('../evaluation', 'no_speed_simple_any_day_012_raw_results.pkl')
pd.concat(results_df_arr).to_pickle(fp)
...
fp = os.path.join('../evaluation', 'no_speed_simple_any_day_234_raw_results.pkl')
pd.concat(results_df_arr).to_pickle(fp)
...
# fp = os.path.join('../evaluation', 'no_speed_simple_baseline_012_raw_results.pkl')
# pd.concat([df1, df2, df3]).to_pickle(fp)

# mse_df = generate_results_over_time_window([df1, df2, df3])
# fp = os.path.join('../evaluation', 'no_speed_simple_baseline_012_results.pkl')
# mse_df.to_pickle(fp)
...
# fp = os.path.join('../evaluation', 'no_speed_simple_baseline_234_raw_results.pkl')
# pd.concat([df1, df2, df3]).to_pickle(fp)

# mse_df = generate_results_over_time_window([df1, df2, df3])
# fp = os.path.join('../evaluation', 'no_speed_simple_baseline_234_results.pkl')
# mse_df.to_pickle(fp)
