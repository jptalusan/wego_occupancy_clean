...
def setup_day_ahead_data(DATE_TO_PREDICT, past_df, darksky, holidays_df, speed_df, TARGET='load'):
...
def setup_input_data(DATE_TO_PREDICT, past_df, model_type='any_day'):
    ...
    input_df = setup_day_ahead_data(DATE_TO_PREDICT, past_df, darksky, holidays_df, speed_df, TARGET='y_reg100')
    return input_df
